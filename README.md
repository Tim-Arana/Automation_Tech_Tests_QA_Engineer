...
update playwright
> npm install -D @playwright/test@latest  OR  npx playwright install --with-deps
...
> Results can be seen by running npx playwright show-report

> >OR Checking under playwright-report folder

> >OR test-results folder.
